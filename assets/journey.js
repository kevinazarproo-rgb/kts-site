...
(function(){
  ...
  var CAT=[
    {id:'paris-louvre',dest:'paris',th:['culture','art','vip'],img:'https://images.pexels.com/photos/32469438/pexels-photo-32469438.jpeg?auto=compress&cs=tinysrgb&w=600',en:'Private Louvre after hours',fr:'Louvre privatisé en nocturne',ben:'A private visit of the Louvre.',bfr:'Une visite privée du Louvre.'},
    {id:'paris-seine',dest:'paris',th:['romance','gastronomy'],img:'https://images.unsplash.com/photo-1526821799652-2dc51675628e?auto=format&fit=crop&w=600&q=70',en:'Seine dinner cruise',fr:'Dîner-croisière sur la Seine',ben:'A dinner cruise on the Seine.',bfr:'Un dîner-croisière sur la Seine.'},
    {id:'riviera-yacht',dest:'riviera',th:['beach','vip','romance'],img:'https://images.pexels.com/photos/27935944/pexels-photo-27935944.jpeg?auto=compress&cs=tinysrgb&w=600',en:'Private yacht day on the Riviera',fr:'Journée en yacht privé sur la Riviera',ben:'A day on a private yacht.',bfr:'Une journée en yacht privé.'},
    {id:'riviera-monaco',dest:'riviera',th:['vip','culture'],img:'https://images.pexels.com/photos/13136997/pexels-photo-13136997.jpeg?auto=compress&cs=tinysrgb&w=600',en:'Monaco glamour & casino',fr:'Monaco glamour & casino',ben:'Monaco and the Monte-Carlo casino.',bfr:'Monaco et le casino de Monte-Carlo.'},
    {id:'provence-lavender',dest:'provence',th:['nature','romance'],img:'https://images.unsplash.com/photo-1499002238440-d264edd596ec?auto=format&fit=crop&w=600&q=70',en:'Lavender fields & hilltop villages',fr:'Champs de lavande & villages perchés',ben:'Lavender fields and hilltop villages.',bfr:'Champs de lavande et villages perchés.'},
    {id:'provence-rose',dest:'provence',th:['gastronomy'],img:'https://images.pexels.com/photos/2954929/pexels-photo-2954929.jpeg?auto=compress&cs=tinysrgb&w=600',en:'Rosé estate tasting',fr:'Dégustation dans un domaine de rosé',ben:'A tasting at a rosé estate.',bfr:'Une dégustation dans un domaine de rosé.'},
    {id:'loire-chateaux',dest:'loire',th:['culture','history','family'],img:'https://images.unsplash.com/photo-1650869653858-1c2c0768014f?auto=format&fit=crop&w=600&q=70',en:'Royal châteaux of the Loire',fr:'Châteaux royaux de la Loire',ben:'A visit of the Loire châteaux.',bfr:'La visite des châteaux de la Loire.'},
    {id:'loire-balloon',dest:'loire',th:['romance','nature','family'],img:'https://images.pexels.com/photos/33890730/pexels-photo-33890730.jpeg?auto=compress&cs=tinysrgb&w=600',en:'Hot-air balloon over the valley',fr:'Montgolfière au-dessus de la vallée',ben:'A hot-air balloon ride over the valley.',bfr:'Un vol en montgolfière au-dessus de la vallée.'},
    {id:'alsace-wineroute',dest:'alsace',th:['gastronomy','culture'],img:'https://images.unsplash.com/photo-1588365399397-f09fd8745464?auto=format&fit=crop&w=600&q=70',en:'Wine Route & Colmar',fr:'Route des Vins & Colmar',ben:'The Wine Route and the town of Colmar.',bfr:'La Route des Vins et la ville de Colmar.'},
    {id:'alsace-xmas',dest:'alsace',th:['family','culture'],img:'https://images.unsplash.com/photo-1481437156560-3205f6a55735?auto=format&fit=crop&w=600&q=70',en:'Christmas markets of Alsace',fr:'Marchés de Noël d\'Alsace',ben:'The Christmas markets of Alsace.',bfr:'Les marchés de Noël d\'Alsace.'},
    {id:'bordeaux-grandcru',dest:'bordeaux',th:['gastronomy','vip'],img:'https://images.unsplash.com/photo-1493564738392-d148cfbd6eda?auto=format&fit=crop&w=600&q=70',en:'Grand Cru château tasting',fr:'Dégustation dans un château Grand Cru',ben:'A tasting at a Grand Cru château.',bfr:'Une dégustation dans un château Grand Cru.'},
    {id:'bordeaux-oysters',dest:'bordeaux',th:['gastronomy','nature'],img:'https://images.pexels.com/photos/33890730/pexels-photo-33890730.jpeg?auto=compress&cs=tinysrgb&w=600',en:'Atlantic oysters & dunes',fr:'Huîtres de l\'Atlantique & dunes',ben:'Oysters in Arcachon and the Dune du Pilat.',bfr:'Huîtres à Arcachon et la Dune du Pilat.'},
    {id:'burgundy-cycling',dest:'burgundy',th:['gastronomy','nature'],img:'https://images.pexels.com/photos/2954929/pexels-photo-2954929.jpeg?auto=compress&cs=tinysrgb&w=600',en:'Grands Crus cycling route',fr:'Route des Grands Crus à vélo',ben:'Cycling on the Grands Crus wine route.',bfr:'Du vélo sur la route des Grands Crus.'},
    {id:'burgundy-beaune',dest:'burgundy',th:['culture','history'],img:'https://images.unsplash.com/photo-1493564738392-d148cfbd6eda?auto=format&fit=crop&w=600&q=70',en:'Hospices de Beaune',fr:'Hospices de Beaune',ben:'A visit of the Hospices de Beaune.',bfr:'La visite des Hospices de Beaune.'},
    {id:'alps-ski',dest:'alps',th:['mountain','vip'],img:'https://images.pexels.com/photos/34605838/pexels-photo-34605838.jpeg?auto=compress&cs=tinysrgb&w=600',en:'Ski in Courchevel',fr:'Ski à Courchevel',ben:'Skiing in Courchevel.',bfr:'Du ski à Courchevel.'},
    {id:'alps-montblanc',dest:'alps',th:['mountain','nature'],img:'https://images.unsplash.com/photo-1605540436563-5bca919ae766?auto=format&fit=crop&w=600&q=70',en:'Mont Blanc & Aiguille du Midi',fr:'Mont Blanc & Aiguille du Midi',ben:'Mont Blanc and the Aiguille du Midi.',bfr:'Le Mont Blanc et l\'Aiguille du Midi.'},
    {id:'alps-chalet',dest:'alps',th:['wellness','vip','mountain'],img:'https://images.pexels.com/photos/34605838/pexels-photo-34605838.jpeg?auto=compress&cs=tinysrgb&w=600',en:'Grand chalet & alpine spa',fr:'Grand chalet & spa alpin',ben:'A chalet with a spa.',bfr:'Un chalet avec spa.'},
    {id:'sey-island',dest:'seychelles',th:['beach','vip','romance'],img:'https://images.unsplash.com/photo-1704317653969-0a8a5ea0dd10?auto=format&fit=crop&w=600&q=70',en:'Private island escape',fr:'Escapade sur une île privée',ben:'A stay on a private island.',bfr:'Un séjour sur une île privée.'},
    {id:'sey-snorkel',dest:'seychelles',th:['beach','nature'],img:'https://images.unsplash.com/photo-1602002418082-a4443e081dd1?auto=format&fit=crop&w=600&q=70',en:'Snorkeling the turquoise lagoons',fr:'Plongée dans les lagons turquoise',ben:'Snorkeling in the lagoons.',bfr:'Du snorkeling dans les lagons.'},
    {id:'corsica-coves',dest:'corsica',th:['beach','nature'],img:'https://images.unsplash.com/photo-1545129228-7a804588bf8e?auto=format&fit=crop&w=600&q=70',en:'Hidden coves by boat',fr:'Criques secrètes en bateau',ben:'A boat trip to the coves.',bfr:'Une sortie en bateau vers les criques.'},
    {id:'corsica-gr20',dest:'corsica',th:['mountain','nature'],img:'https://images.unsplash.com/photo-1565008576549-57569a49371d?auto=format&fit=crop&w=600&q=70',en:'Mountains meet the sea',fr:'La montagne rencontre la mer',ben:'Hiking between the mountains and the sea.',bfr:'De la randonnée entre montagne et mer.'},
    {id:'normandy-msm',dest:'normandy',th:['culture','history','nature'],img:'https://images.pexels.com/photos/8430047/pexels-photo-8430047.jpeg?auto=compress&cs=tinysrgb&w=600',en:'Mont-Saint-Michel at low tide',fr:'Mont-Saint-Michel à marée basse',ben:'Mont-Saint-Michel and its bay.',bfr:'Le Mont-Saint-Michel et sa baie.'},
    {id:'normandy-dday',dest:'normandy',th:['history','culture'],img:'https://images.unsplash.com/photo-1707209909974-8f0a3a3e2d3a?auto=format&fit=crop&w=600&q=70',en:'D-Day landing beaches',fr:'Plages du Débarquement',ben:'The D-Day landing beaches.',bfr:'Les plages du Débarquement.'},
    {id:'normandy-giverny',dest:'normandy',th:['art','romance','nature'],img:'https://images.unsplash.com/photo-1550948390-6eb7fa773072?auto=format&fit=crop&w=600&q=70',en:"Monet's garden at Giverny",fr:'Jardins de Monet à Giverny',ben:'Monet\'s garden in Giverny.',bfr:'Les jardins de Monet à Giverny.'}
  ,
    {id:'paris-versailles',dest:'paris',th:['culture','history','family'],img:'https://images.pexels.com/photos/32469438/pexels-photo-32469438.jpeg?auto=compress&cs=tinysrgb&w=600',en:'Palace of Versailles, privately',fr:'Château de Versailles en privé',ben:'A visit of the Palace of Versailles.',bfr:'La visite du château de Versailles.'},
    {id:'paris-dining',dest:'paris',th:['gastronomy','vip'],img:'https://images.unsplash.com/photo-1526821799652-2dc51675628e?auto=format&fit=crop&w=600&q=70',en:'Michelin dining & private chef',fr:'Dîner étoilé & chef privé',ben:'A Michelin-starred dinner in Paris.',bfr:'Un dîner étoilé à Paris.'},
    {id:'riviera-eze',dest:'riviera',th:['culture','art'],img:'https://images.pexels.com/photos/13136997/pexels-photo-13136997.jpeg?auto=compress&cs=tinysrgb&w=600',en:'Èze & Saint-Paul-de-Vence',fr:'Èze & Saint-Paul-de-Vence',ben:'The villages of Èze and Saint-Paul-de-Vence.',bfr:'Les villages d\'Èze et Saint-Paul-de-Vence.'},
    {id:'provence-verdon',dest:'provence',th:['nature','family'],img:'https://images.unsplash.com/photo-1499002238440-d264edd596ec?auto=format&fit=crop&w=600&q=70',en:'Verdon gorges by kayak',fr:'Gorges du Verdon en kayak',ben:'Kayaking in the Verdon gorges.',bfr:'Du kayak dans les gorges du Verdon.'}
  ];
